...
public class FlingshotNeoForgeConfigScreen extends Screen {
    ...
    public FlingshotNeoForgeConfigScreen(Screen parent) {
    ...
    public static void register(ModContainer modContainer) {
        modContainer.registerExtensionPoint(
                ...
                (container, parent) -> new FlingshotNeoForgeConfigScreen(parent)
        );
    }
